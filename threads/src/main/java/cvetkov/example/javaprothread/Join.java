...
//        Благодаря join() поток main досчитает до 50, потом подождет завершения потока t, и потом досчитает до 100
        t0.join();
...
//        Основной поток main не будет ожидать окончания выполнения фонового потока
        t0.setDaemon(true); //до конца он не допечатаетя так как мэйн остановиться раньше и остановиться т0
