...
public class JdbcDemo {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        try (var connection = DriverManager.getConnection(URL, USER, PASSWORD)) { //создаем соединение
    ...
    private void insertRecord(Connection connection, int id) throws SQLException {
        try (var pst = connection.prepareStatement("insert into test(id, name) values (?, ?)")) { //в prepareStatement у нас шаблон с плйсхолдерами
