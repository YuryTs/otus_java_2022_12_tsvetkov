...
// Работа с клиентом
        ...
        RefflectionJdbcImpl<Client> reflectionUtilsClient = new RefflectionJdbcImpl<>(entityClassMetaDataClient);
...
// Сделайте тоже самое с классом Manager (для него надо сделать свою таблицу)
        ...
        RefflectionJdbcImpl<Manager> reflectionUtilsManager = new RefflectionJdbcImpl<>(entityClassMetaDataManager);
