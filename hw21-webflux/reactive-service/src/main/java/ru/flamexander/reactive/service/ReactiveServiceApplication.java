...
public class ReactiveServiceApplication {
	/*
	 TODO Домашнее задание:
	   - Переработать ProductDetailsController
	   таким образом, чтобы он
	   возвращал DetailedProductDto,
	   который собирается из
	   продукта из базы и
	   ответа от сервиса деталей.
	   DetailedProductDto должен включать в себя поля
	     id, name, description.
	     Следует учесть что в сервисе деталей может не оказаться записи, соответствующей
